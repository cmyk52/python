...
print(not True) 
print(not (edad > 17)) # Para el caso evaluaremos que edad sea mayor a 17, como estamos negando la evaluacion True, dara como resultado False. *not ejecutara todo lo que era dentro de las parentesis.
